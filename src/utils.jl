...
Base.@propagate_inbounds mulrow!(v::AbstractVector, i::Int, f) = (v[i] *= f; v)
...
Base.@propagate_inbounds mulcol!(v::AbstractVector, i::Int, f) = (v[i] *= f; v)
...
Base.@propagate_inbounds unrows!(state::AbstractVector, inds::AbstractVector, U::IMatrix) = state
